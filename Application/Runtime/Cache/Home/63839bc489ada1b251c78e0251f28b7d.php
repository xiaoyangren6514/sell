...
<div class="header_bg">
    ...
    <form id="searchForm" method="get" action="#">
        ...
        <input name="imageField" value=" " class="go"
               style="cursor: pointer; background: url('<?php echo IMAGE_URL?>sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;"
               type="submit"/>
                ...
                <div class="box_1">
                    <div class="top10List clearfix">
                        <ul class="clearfix">
                            ...
                            <li class="topimg">
                                <a href="#"><img src="<?php echo IMAGE_URL?>3_thumb_G_1241422082679.jpg"
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="topimg">
                                <a href="#"><img src="<?php echo IMAGE_URL?>24_thumb_G_1241971981429.jpg"
                                                 alt="" class="samllimg"></a>
                            </li>
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="topimg">
                                <a href="#"><img src="<?php echo IMAGE_URL?>12_thumb_G_1241965978410.jpg"
                                                 alt="" class="samllimg"></a>
                            </li>
            ...
            <div class="box"><h3><span>品牌专区</span></h3>
                ...
                <div class="box_1">
                    <div class=" brands clearfix">
                        <a href="#"><img src="<?php echo IMAGE_URL?>1240803062307572427.gif"
                                         alt="诺基亚 (7)"></a>
                        <a href="#"><img src="<?php echo IMAGE_URL?>1240802922410634065.gif"
                                         alt="摩托罗拉 (1)"></a>
                        <a href="#"><img src="<?php echo IMAGE_URL?>1240803144788047486.gif"
                                         alt="多普达 (1)"></a>
                    </div>
                </div>
            </div>
        ...
        <div class="AreaM">
            ...
            <div id="show_hot_area" class="clearfix">
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo IMAGE_URL?>9_thumb_G_1241511871555.jpg" alt="诺基亚E66"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo IMAGE_URL?>1_thumb_G_1240902890710.jpg" alt="KD876"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo IMAGE_URL?>8_thumb_G_1241425513488.jpg"
                                     alt="飞利浦9@9v" class="goodsimg"></a><br/>
    ...
    <div class="box_1">
        <div class="links clearfix">
            <a href="#" target="_blank" title="YONGDA商城"><img
                    src="<?php echo IMAGE_URL?>ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>
